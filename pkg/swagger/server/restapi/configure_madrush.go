...
//go:generate swagger generate server --target ../../server --name Madrush --spec ../../swagger.yml --exclude-main

func configureFlags(api *operations.MadrushAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.MadrushAPI) http.Handler {
